...
define('RETAILER_ECOMMERCE_FREE_URL',__('https://www.titanthemes.net/themes/free-ecommerce-wordpress-theme/','retailer-ecommerce'));
define('RETAILER_ECOMMERCE_PREMIUM_DOCUMENTATION',__('https://www.titanthemes.net/documentation/retailer-ecommerce-pro/','retailer-ecommerce'));
                ...
                <div class="theme-detail">
                   <div class="retailer-ecommerce-admin-card-header-1">
                        ...
                        <div class="retailer-ecommerce-header-right-2">
                            ...
                            <div class="retailer-ecommerce-pro-button">
                                <a href="<?php echo esc_url( RETAILER_ECOMMERCE_PREMIUM_DOCUMENTATION ); ?>" class="retailer-ecommerce-button button-primary-1 buy-now" target="_blank" rel="noreferrer">
                                    <?php esc_html_e( 'PRO DOCUMENTATION', 'retailer-ecommerce' ); ?>
                                </a>
                            </div> 
                        </div>
                    </div>
